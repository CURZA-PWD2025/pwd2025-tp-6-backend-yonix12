...
const emit = defineEmits(['editar-marca']);
...
const manejarEliminar = async (id: number) => {
  if (confirm('¿Estás seguro de que quieres eliminar esta marca?')) {
    try {
      await marcaStore.eliminarMarca(id);
